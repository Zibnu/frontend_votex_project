    ...
    return (
        <div className='fixed inset-0 bg-black/40 flex justify-center items-center z-50'>
            ...
            className="bg-white rounded-2xl p-6 w-[400px] relative">
                ...
                <h2 className="text-xl font-bold text-center text-[#1A3C28] mb-3">
                    Reset Data Voted
                </h2>

                <p className="text-center text-[#37474F] text-sm mb-6">
                ...
                <div className="flex justify-between gap-3">
                    <button 
                    onClick={onClose}
                    className="w-full py-2 bg-gray-200 rounded-lg cursor-pointer">
                        Cancel
                    </button>

                    <button 
                    onClick={onReset}
                    className="w-full py-2 bg-[#EF4444] text-[#F5F7F5] rounded-lg hover:bg-[#c72f2f] cursor-pointer">
                        Reset
                    </button>
                </div>
            </motion.div>
